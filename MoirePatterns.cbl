      ...
      *Variables used to store the square root defined with PIC 9(4)
      *to any value that doesn't truncate, you will just get an annulus
       01  ARITHMETIC-VARIABLES.
           03  X-VAR-MINUS-X-SET           PIC S9(4).
           03  X-VAR-MINUS-X-SET-SQ        PIC 9(4). *>
           03  Y-VAR-MINUS-Y-SET           PIC S9(4). *>
           03  Y-VAR-MINUS-Y-SET-SQ        PIC 9(10).
      *These are used to test if the equation is working.
       01  FINAL-VALUE                     PIC 9(4). *>
